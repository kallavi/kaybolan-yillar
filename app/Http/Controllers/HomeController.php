    ...
    public function getProject(Request $request)
    {
        ...
        foreach ($project as $index => $item) {
            ...
            if ($project->currentPage()==1) {
                ...
                $card .= '    <div class="card animate__animated animate__fadeInUp" data-wow-delay="1.' . $count . 's"  data-bs-toggle="modal" data-bs-target="#cardModal" data-subtitle="' . $item->subtitle . '" data-image="' . $item->image . '"
                data-description="' . $item->description . '">
                <div class="card-body">
                    <div class="imageFrame">
                        <img src="' . asset($item->image) . '" alt="">
